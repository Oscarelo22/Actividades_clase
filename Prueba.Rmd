...
```{r}
ggplot(Mode)+
  geom_bar(aes(choice), color="black", fill="#48C9B0")+
  theme_bw()
```
...
```{r}
ggplot(Mode)+
  geom_density(aes(cost.car), color="black", fill="#229954", alpha=0.6)+
  geom_density(aes(cost.carpool), color="black", fill="#8E44AD" , alpha=0.6)+
  geom_density(aes(cost.bus), color="black", fill="#2980B9", alpha=0.6)+
  geom_density(aes(cost.rail), color="black", fill="#F39C12", alpha=0.6)+
  theme_bw()
```
...
```{r}
ggplot(Mode)+
  geom_density(aes(time.car), color="black", fill="#229954", alpha=0.4)+
  geom_density(aes(time.carpool), color="black", fill="#8E44AD" , alpha=0.4)+
  geom_density(aes(time.bus), color="black", fill="#2980B9", alpha=0.4)+
  geom_density(aes(time.rail), color="black", fill="#F39C12", alpha=0.4)+
  theme_bw()
```
